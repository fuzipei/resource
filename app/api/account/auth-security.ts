...
export function verifyInvite(expected:string,provided:unknown){if(!expected)throw new AuthSecurityError('Registration invite is not configured',503);if(typeof provided!=='string'||provided.trim()!==expected)throw new AuthSecurityError('邀请码不正确，请确认后重试。',403)}
